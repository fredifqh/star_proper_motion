...
std::vector<double> ProperMotion(double hourRA, double minuteRA,  \
	                                                    double secondRA, double degreDec,\
	                                                    double minuteDec, double secondDec, double muAlpha, double muDelta, double radialVelocity, double paralaxe, double time)
{
